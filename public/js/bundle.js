...
var displayMap = function displayMap(locations) {
  mapboxgl.accessToken = 'pk.eyJ1IjoiaHV5dG9jZG8iLCJhIjoiY2p5d214N3hwMDh5cjNmbzFwZDduc2Q2eiJ9.G-xakp6YkI8QDqY2kXiZiA';
  var map = new mapboxgl.Map({
    container: 'map',
    style: 'mapbox://styles/huytocdo/cjywnd5pm24rl1cqxn8yvcueb',
    scrollZoom: false
  });
    ...
    return regeneratorRuntime.wrap(function _callee$(_context) {
      while (1) {
        switch (_context.prev = _context.next) {
          case 0:
            _context.prev = 0;
            url = type === 'password' ? '/api/v1/users/update-my-password' : '/api/v1/users/update-me';
            _context.next = 4;
            return (0, _axios.default)({
              method: 'PATCH',
              url: url,
...
var stripe = Stripe('pk_test_4CKl1yejaNOg6Hn0kmDcXDjA00fNv7S76P');
